            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  defaultValue={
                    initialData?.verificationStatus || "BELUM_TERVERIFIKASI"
                  }
                  className="w-full px-3 py-2 bg-card border border-border rounded-lg text-foreground text-sm focus:outline-none focus:border-primary"
                >
                  <option value="BELUM_TERVERIFIKASI">
                    BELUM TERVERIFIKASI (Mentah)
                  </option>
                  <option value="MENUNGGU_VERIFIKASI">
                    MENUNGGU VERIFIKASI (Proses Review)
                  </option>
                  <option value="TERVERIFIKASI">
                    TERVERIFIKASI (Sah / Valid)
                  </option>
                </select>
              </div>
            </div>
