...
export default async function IndustriKelapaPage() {
  ...
  if (!sector) {
    return <div className="text-center py-20">Sektor Industri Kelapa tidak ditemukan.</div>;
  }
  ...
  return (
    <div className="bg-white min-h-screen pt-20 text-[#172121]">
      <section 
        ...
        style={{ background: "linear-gradient(135deg, #F6A236 0%, #0D726D 100%)" }}
      >
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <span className="inline-block px-4 py-1.5 rounded-full bg-white/15 text-white border border-white/30 text-xs font-bold uppercase tracking-widest mb-6 backdrop-blur-md shadow-sm">
            🥥 Sektor Industri Kelapa • Orange Accent + Teal
          </span>
