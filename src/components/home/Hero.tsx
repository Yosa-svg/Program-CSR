  ...
  return (
    <section className="relative min-h-screen flex items-center pt-24 pb-20 overflow-hidden bg-[#0A3D3A]">
      ...
      <div 
        ...
        style={{
          background: "linear-gradient(135deg, #0D726D 0%, #158F88 55%, #F6A236 100%)"
        }}
      ></div>
        ...
        <div className="max-w-[680px]">
          ...
          >
            <div>
              ...
              <p className="text-sm text-white/80 font-medium">Penerima Manfaat</p>
            </div>
            <div>
              <p className="text-3xl md:text-4xl font-bold text-white mb-1 drop-shadow-sm">12</p>
              <p className="text-sm text-white/80 font-medium">Desa Terhubung</p>
            </div>
